...
(function () {
	...
	// 删除ＣＳＤＮ广告
	// 立此flag，非删掉你不可
	if(pageHost == "blog.csdn.net"){
		window.setInterval(function() { document.querySelector('aside').remove();document.querySelector('.indexSuperise ').remove();}, 30);
		document.getElementsByClassName('indexSuperise').seta
	}
